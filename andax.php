													...
													<span class="otp_container relative w-full flex items-center bg-gray-100 py-5">
														...
														<?php  if($getAdmin['mfa_qrcode_enabled'] == 0){?>
															<form method="post" class="flex items-end h-full ml-auto">
																<input onclick="en_dis_qr(event)" type="submit" name="qr_mfa" class="qrButtons_en ml-auto h-14 bg-green-400 hover:bg-green-500 text-white mr-5 py-3 px-7 rounded-lg trans-3" value="Activate"/>
														<?php }else{?>
																<input onclick="en_dis_qr(event)" type="submit" name="qr_mfa" class="qrButtons_dis ml-auto h-14 bg-red-400 hover:bg-red-500 text-white mr-5 py-3 px-7 rounded-lg trans-3" value="Deactivate"/>
															</form>
														<?php }  ?>
													</span>
												</div>
											...
											<div class="flex my-2">
													<span class="otp_container relative w-full flex items-center bg-gray-100 py-5">
														...
														<?php  if($getAdmin['mfa_pincode_enabled'] == 0){?>
															<form method="post" class="flex items-end h-full ml-auto">
																<input onclick="en_dis_pincode(event)" type="submit" name="pincode_mfa" class="pincodeButtons_en ml-auto h-14 bg-green-400 hover:bg-green-500 text-white mr-5 py-3 px-7 rounded-lg trans-3" value="Activate"/>
														<?php }else{?>
																<input onclick="en_dis_pincode(event)" type="submit" name="pincode_mfa" class="pincodeButtons_dis ml-auto h-14 bg-red-400 hover:bg-red-500 text-white mr-5 py-3 px-7 rounded-lg trans-3" value="Deactivate"/>
															</form>
														<?php }  ?>
													</span>
												</div>
...
<!-- FOR QR ACTIVATE AND DEACTIVATE -->
	<script>
		function en_dis_qr(event){
			const qrButtons_en = document.querySelector('.qrButtons_en')
			const qrButtons_dis = document.querySelector('.qrButtons_dis')

			if(event.target == qrButtons_en){
				window.location.replace('en__qr.php')
			}

			if(event.target == qrButtons_dis){
...
<!-- FOR PINCODE ACTIVATE AND DEACTIVATE -->
	<script>
		function en_dis_pincode(event){
			const pincodeButtons_en = document.querySelector('.pincodeButtons_en')
			const pincodeButtons_dis = document.querySelector('.pincodeButtons_dis')

			if(event.target == pincodeButtons_en){
				window.location.replace('en__pincode.php')
			}

			if(event.target == pincodeButtons_dis){
